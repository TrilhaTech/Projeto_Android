...
public class ResultadoDataset {
    ...
    public static List<Resultado> getlista2(){
        ...
        lista.add(new Resultado("Redes",
                ...
                R.mipmap.guanabara2, "Gustavo Guanabara", "Essa trilha irá te ajudar com redes de computadores"));        return lista;
    }
    public static List<Resultado> getlista3(){
        ...
        lista.add(new Resultado("Gerenciador de projetos",
                ...
                R.mipmap.andriele, "Andriele Ribeiro", "Essa trilha irá te ajudar com sua carreira em gestão"));        return lista;
    }
    public static List<Resultado> getlista4(){
        ...
        lista.add(new Resultado("Tester/QA",
                ...
                R.mipmap.fontetv, "Código Fonte TV", "Essa trilha irá te ajudar como se tornar um otimo analista"));        return lista;
    }
    public static List<Resultado> getlista5(){
        ...
        lista.add(new Resultado("Analísta de dados",
                ...
                R.mipmap.dinamica, "Programação Dinâmica", "Essa trilha irá te ajudar com seus primeiros passos em dados"));        return lista;
    }
}
